...
/**
 * Servlet implementation class PopulateEditUserController
 */
@WebServlet("/PopulateEditUserController")
public class PopulateEditUserController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PopulateEditUserController() {
        super();
